      ...
      <div className="flex flex-col gap-3 p-4 pt-2">
        ...
        {openSection === 'api' && (
          <>
            ...
            <ApiSectionButton orderClass="order-[13]" id="image" openApiSection={openApiSection} onToggle={toggleApiSection} icon={<ImageIcon className="h-4 w-4" />} title="图片生成" subtitle="通用画图与配图" />
