...
const bubbleFramePresets = [
  ...
  // 可爱男孩气泡框 - 边缘贴卡通小人
  { id: 'cute-boy', name: '可爱男孩', type: 'css', gradient: 'linear-gradient(135deg, #FFF5E6 0%, #FFE4CC 50%, #FFDAB9 100%)', borderColor: '#FFDAB9', decorColor: '', decorIcon: '', decorImage: cuteBoyHead },
];
